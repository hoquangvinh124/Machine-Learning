...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(565, 539)
        self.centralwidget = QtWidgets.QWidget(parent=MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.label = QtWidgets.QLabel(parent=self.centralwidget)
        self.label.setGeometry(QtCore.QRect(100, 0, 371, 41))
        font = QtGui.QFont()
        ...
        self.groupBox.setGeometry(QtCore.QRect(20, 450, 521, 61))
        self.groupBox.setStyleSheet("")
        self.groupBox.setObjectName("groupBox")
        self.pushButtonRemove = QtWidgets.QPushButton(parent=self.groupBox)
        self.pushButtonRemove.setGeometry(QtCore.QRect(390, 20, 101, 28))
        ...
        self.pushButtonInsert.setGeometry(QtCore.QRect(170, 20, 91, 28))
        self.pushButtonInsert.setStyleSheet("")
        ...
        self.pushButtonNew.setGeometry(QtCore.QRect(70, 20, 81, 28))
        ...
        self.pushButtonUpdate.setGeometry(QtCore.QRect(280, 20, 91, 28))
        self.pushButtonUpdate.setStyleSheet("")
        self.pushButtonUpdate.setIconSize(QtCore.QSize(24, 24))
        self.pushButtonUpdate.setObjectName("pushButtonUpdate")
        self.groupBox_2 = QtWidgets.QGroupBox(parent=self.centralwidget)
        self.groupBox_2.setGeometry(QtCore.QRect(20, 240, 521, 201))
        ...
        self.pushButtonAvatar.setGeometry(QtCore.QRect(300, 160, 71, 23))
        self.pushButtonAvatar.setStyleSheet("")
        ...
        self.lineEditId.setGeometry(QtCore.QRect(70, 20, 171, 22))
        ...
        self.pushButtonRemoveAvatar.setGeometry(QtCore.QRect(390, 160, 111, 23))
        self.pushButtonRemoveAvatar.setStyleSheet("")
        self.pushButtonRemoveAvatar.setObjectName("pushButtonRemoveAvatar")
        self.groupBox_3 = QtWidgets.QGroupBox(parent=self.centralwidget)
        self.groupBox_3.setGeometry(QtCore.QRect(20, 40, 521, 181))
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Hế sờ lô"))
        self.label.setText(_translate("MainWindow", "Phần mềm chấm công"))
        ...
        self.groupBox_2.setTitle(_translate("MainWindow", "Kính chiếu yêu:"))
        ...
        self.groupBox_3.setTitle(_translate("MainWindow", "Danh sách học sinh:"))
